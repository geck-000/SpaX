...
From this laptop (`~/SpaX`):
```bash
WD=puhti:/scratch/project_XXXXXX/test_rve
...
```bash
ssh puhti; cd /scratch/project_XXXXXX/test_rve
...
```bash
scp puhti:/scratch/project_XXXXXX/test_rve/results_si2nd.csv ./   # now 12 rows
...
scp puhti:/scratch/project_XXXXXX/test_rve/results_failure.csv ./
